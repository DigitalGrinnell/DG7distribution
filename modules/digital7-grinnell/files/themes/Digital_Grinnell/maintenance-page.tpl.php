...
<a href="http://!!!!03!!!!" target="_blank" title="Click here to open the Grinnell College home page." class="art-logo art-logo-1572483919">
    <img src="<?php echo Digital_Grinnell_art_get_full_path_to_theme().'/'; ?>images/logo-1572483919.png" alt="" />
</a><a href="node" target="_self" title="Click here to return to the Digital Grinnell home page." class="art-logo art-logo-1567246043">
    <img src="<?php echo Digital_Grinnell_art_get_full_path_to_theme().'/'; ?>images/logo-1567246043.png" alt="" />
</a>
