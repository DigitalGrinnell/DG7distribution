...
resizeData['logo-1572483919'] = {
   responsive: [
                  { left: 0.02, top: 0.02, visible: true }, 
                  { left: 0.02, top: 0.02, visible: true }, 
                  { left: 0.02, top: 0.02, visible: true }, 
                  { left: 0.02, top: 0.02, visible: true }, 
                  { left: 0.02, top: 0.02, visible: true }, 
...
resizeData['logo-1567246043'] = {
   responsive: [
                  { left: 0.5, top: 0.92, visible: true }, 
                  { left: 0.5, top: 0.92, visible: true }, 
                  { left: 0.5, top: 0.92, visible: true }, 
                  { left: 0.5, top: 0.92, visible: true }, 
                  { left: 0.5, top: 0.92, visible: true }, 
...
resizeData['object227400126'] = {
   responsive: [
                  { left: 0.98, top: 0.04, visible: true }, 
                  { left: 0.98, top: 0.04, visible: true }, 
                  { left: 0.98, top: 0.04, visible: true }, 
                  { left: 0.98, top: 0.04, visible: true }, 
                  { left: 0.98, top: 0.04, visible: true }, 
...
jQuery(function ($) {
    'use strict';
    $('ul.art-hmenu a.active + ul, ul.art-vmenu a.active + ul, ul.art-hmenu a.active-trail + ul, ul.art-vmenu a.active-trail + ul').addClass('active');
});
