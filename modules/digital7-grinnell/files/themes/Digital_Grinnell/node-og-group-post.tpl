...
<?php echo Digital_Grinnell_art_node_title_output($title, $node_url, $page); ?>
<?php print render($title_suffix); ?>

                                                <?php if ($submitted): ?>
<div class="art-postheadericons art-metadata-icons"><?php echo Digital_Grinnell_art_submitted_worker($date, $name); ?>
</div><?php endif; ?>
  ...
  <?php
    ...
    hide($content['links']);
    $terms = Digital_Grinnell_art_terms_D7($content);
