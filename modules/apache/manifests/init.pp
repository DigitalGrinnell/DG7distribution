## MAM - Added .conf extension to vagrant_webroot filename to satisfy the
## 'IncludeOptional sites-enabled/*.conf' directive in /etc/apache2/apache2.conf
## per http://stackoverflow.com/questions/20591889/site-does-not-exist-error-for-a2ensite.
